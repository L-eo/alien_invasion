...
from bg_image_roll import bg_image_roll
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets,
    ...
    """更新屏幕上的图像，并切换到新屏幕"""
    bg_image_roll(ai_settings, screen, bgimage,bg_position)  # 控制背景图片
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, 
    ...
    if len(aliens) == 0:
        # 删除所有子弹，加快游戏节奏，提高等级，并创建一个新的外星人群
        bullets.empty()
